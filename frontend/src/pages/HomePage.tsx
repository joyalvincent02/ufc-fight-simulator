      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <section className="flex flex-col items-center text-center pt-28 pb-20">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/events"
              className="px-6 py-3 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold transition shadow-md"
            >
              Browse Events
            </Link>
            <Link
              to="/custom"
              className="px-6 py-3 rounded-lg bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-semibold transition shadow-md"
            >
              Custom Simulation
            </Link>
          </div>
        ...
        <section className="grid md:grid-cols-3 gap-8 py-16">
          {[
            ...
            <div
              key={i}
              className="bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 rounded-lg shadow hover:shadow-lg transition text-center"
            >
