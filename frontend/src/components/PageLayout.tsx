...
export default function PageLayout({ title, children, className = "" }: PageLayoutProps) {
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-white py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden ${className}`}>
